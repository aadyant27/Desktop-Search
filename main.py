...
9. [done] ADD REDIRECTING FUNCTIONALITY 
    9.1 [done] STORE 5 RESULTS IN AN ARRAY
    9.2 [done] ASK USER TO INPUT, WHICH FILE THEY WANT TO GO TO FROM 1-5
    9.3 [done] BASED ON THE INPUT SELECT THE PATH OF THE FILE FROM THE ARRAY 
    9.4 [done] REDIRECT (to open a file from terminal, we use "open file_path")
'''